...
function Quiz() {
  ...
  return (
    <div className='cardContact'>
      ...
      {modal?<Modal handleClose={handleClose}/>:null}
      <form onSubmit={handleSubmission}>
        ...
        {toggle ? (
          ...
          <p>Please Answer Questions to See Results</p>
        )}
        ...
        <fieldset className='easyQuestions'>
          ...
          <div>
            <input
              ...
              onChange={handleChange}
            ></input>
            <label htmlFor='docRequired'>
              A document required for tax filing
            </label>
          </div>
          <div>
            <input
        ...
        {toggle ? (
          <div>
            {formValues.budget === 'correct' ? (
              <p>✅ ANSWER: A plan for spending and saving money </p>
            ) : (
              <p>❌ ANSWER:A plan for spending and saving money</p>
            )}
          </div>
        ...
        {toggle ? (
          <div>
            {formValues.checkingAccount === 'correct' ? (
              <p>✅ ANSWER: To store and manage your day-to-day finances </p>
            ) : (
              <p>❌ ANSWER:A plan for spending and saving money</p>
            )}
          </div>
        ...
        {toggle ? (
          <div>
            {formValues.allocating === 'correct' ? (
              <p>
                ✅ ANSWER: It's a guideline to allocate 50% of your income to
                essentials, 30% to wants, and 20% to savings and debt repayment.{' '}
              </p>
            ) : (
              <p>
                ❌ ANSWER:It's a guideline to allocate 50% of your income to
        ...
        {toggle ? (
          <div>
            {formValues.creditScore === 'correct' ? (
              <p>✅ ANSWER: $7,000</p>
            ) : (
              <p>❌ ANSWER:$7,000</p>
            )}
        ...
        {toggle ? (
          <div>
            {formValues.IRAcontributionLIMIT === 'correct' ? (
              <p>
                ✅ ANSWER: A numerical representation of an individual's
                creditworthiness, typically ranging from 300 to 850
              </p>
            ) : (
              <p>
                ❌ ANSWER: A numerical representation of an individual's
        ...
        {toggle ? (
          <div>
            {formValues.financialEmpowerment === 'correct' ? (
              <p>✅ ANSWER: True</p>
            ) : (
              <p>❌ ANSWER: True</p>
            )}
